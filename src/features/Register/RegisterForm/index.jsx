        ...
        <div className="register__forms">
          <form className="register__register" onSubmit={handleSubmit(handleSubmitForm)}>
            ...
            <div className="register__box">
              ...
              <input type="password" placeholder="Password" name="password" className="register__input" ref={register} />
            </div>
            {
            ...
            <div className="register__box">
              <i className='bx bx-key register__icon'></i>
              <input type="password" placeholder="Password" name="retypePassword" className="register__input" ref={register} />
            </div>
            {
              Object.keys(errors).length > 0 ? <p className="register__error">{errors.retypePassword?.message}</p> : null
            }
